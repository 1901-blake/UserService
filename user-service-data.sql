...
INSERT INTO sms_users (first_name, last_name, email, phone_number, training_address, user_status)
	VALUES ('Blake', 'Kruppa', 'blake.kruppa@revature.com', '9093804081', (SELECT address_id FROM addresses WHERE alias = 'USF'), 8),
		   ('Alec', 'Batson', 'abatson94@gmail.com', '9093804081', (SELECT address_id FROM addresses WHERE alias = 'Reston'), 8),
...
delete from sms_users where sms_user_id = 2;

INSERT INTO sms_users (first_name, last_name, email, phone_number, training_address, user_status)
	VALUES ('Aaron', 'Gravelle', 'agrav12825@gmail.com', '9093804081', (SELECT address_id FROM addresses WHERE alias = 'USF'), 8)
